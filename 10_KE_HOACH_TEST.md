...
> **Smoke deploy:** `npm run lab:smoke` vẫn là black-box prod-safe; `SMOKE_ALLOW_RANKED_WRITE=1 npm run lab:smoke` là gate opt-in có ghi ranked game/ELO thật.
