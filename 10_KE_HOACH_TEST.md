...
| Smoke test Pikafish thật (mục 11 của [`11_KE_HOACH_TICH_HOP_ENGINE.md`](11_KE_HOACH_TICH_HOP_ENGINE.md)) | `npm run engine:smoke`, `npm run engine:smoke:quota` / workflow `engine-smoke` | **Cần binary + NNUE thật** | script; PASS thật sau deploy/local Docker |
