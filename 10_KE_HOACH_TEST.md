...
- [x] **P-F1 — S13 Cờ Úp: luật đi quân/reveal/undo.** Ưu tiên P0. Auto-test trong `xiangqi_cup_game_test.dart` phải phủ: quân úp đi nước đầu theo quân vỏ, sau khi lật đi theo quân thật, bắt quân úp trả về quân thật bị bắt, undo khôi phục hidden map, shuffle giữ đúng multiset quân mỗi bên, và legality không được để reveal tạo thế tự chiếu/lộ mặt tướng.
