...
>
> **Trạng thái test tự động 2026-06-19:** Backend `cd cchess-backend && npm test` → **66/66 xanh** (10 file). Flutter `cd cchess && flutter test` → **205/205 xanh** (20 file). Chi tiết ở Nhóm T (§8).
...
> **Flutter `flutter test` tổng cộng 205/205 xanh** (20 file — `online_match_controller_test.dart` 47 test + `online_result_format_test.dart` 16 test).
